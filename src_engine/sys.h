...
namespace ft {
	struct Table {
		...
		// Input
		struct Input {
			std::function<bool(input::Keys)> isKeyRelease;
			std::function<bool(input::Keys)> isKeyPressOnce;
			std::function<bool(input::Keys)> isKeyPress;
			std::function<bool(input::Keys)> isKeyReleaseOnce;
			...
			*/
			std::function<bool(input::MouseButtons)> isMouseButtonRelease;
			std::function<bool(input::MouseButtons)> isMouseButtonPressOnce;
			std::function<bool(input::MouseButtons)> isMouseButtonPress;
			std::function<bool(input::MouseButtons)> isMouseButtonReleaseOnce;
			...
			/*
				...
				void getMouseVelocity(MouseCoord& mc);
			*/
			std::function<void(input::MouseCoord&)> getMousePosition;
			std::function<void(input::MouseCoord&)> getMouseVelocity;
			
			/*
				// Mouse Wheel
				void getMouseWheel(MouseWheel& mw);
			*/
			std::function<void(input::MouseWheel&)> getMouseWheel;
			...
			/*
				...
				void toggleGrab();
			*/
			std::function<bool()> isGrab;
			std::function<void(bool)> setGrab;
			...
			/*
				...
				bool isInputMapReleaseOnce(std::string name);
			*/
			std::function<void(std::string, const input::InputMap&)> createInputMapping;
			std::function<input::InputMap(input::Keys)> createInputMapKey;
			std::function<input::InputMap(input::MouseButtons)> createInputMapMouseButton;
			std::function<void()> clearInputMaps;
			std::function<bool(std::string)> isInputMapRelease;
			std::function<bool(std::string)> isInputMapPressOnce;
			std::function<bool(std::string)> isInputMapPress;
			std::function<bool(std::string)> isInputMapReleaseOnce;
